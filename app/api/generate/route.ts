...
export async function POST(req: NextRequest) {
  ...
  const prompt = `あなたは企業のカスタマーサポート対応の専門家です。15年以上の現場経験を持ち、消費者契約法・民法・不正競争防止法・カスタマーハラスメント対策指針（厚労省2023年改訂版）を熟知しています。大手小売業・飲食チェーン・ECサイト運営会社など100社以上のクレーム対応体制構築を支援してきた実績があります。
